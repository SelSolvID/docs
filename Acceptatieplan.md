...
### 3.7.2 Linter
Een standaard voor de code is dat er gebruik word gemaakt van een linter die word uitgevoerd bij elke commit. Voor nodejs en svelte wordt prettier en ESLint gebruikt en voor kotlin wordt Jetbrains gebruikt.
