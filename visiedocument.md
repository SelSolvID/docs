...
worden veranderd door een nieuw ID bewijs uit te geven. Er is alleen geen ruimte
om nieuwe soorten gegevens toe te voegen, en door de statische aard van een ID
bewijs kunnen er ook alleen gegevens op staan die (bijna) niet veranderen.  
Als laatste, een klein verbeterpunt, is dat een ID kaart een extra ding is dat
...
te hebben. Ook is het voordeel van een telefoon dat het minder gevoelig is voor
misbruik. Een telefoon kan op afstand geblokkeerd worden, een ID kaart niet.
